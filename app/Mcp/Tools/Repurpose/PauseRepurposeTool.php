...
#[Description('Pause a repurpose. Polling stops but the watermark is kept, so resuming continues from where it left off.')]
class PauseRepurposeTool extends Tool
{
    ...
    public function handle(Request $request): Response|ResponseFactory
    {
        ...
        try {
            $repurpose = PauseRepurpose::execute($repurpose);
    ...
    {
        return [
            'repurpose_id' => $schema->string()->required()->description('The repurpose to pause.'),
        ];
    }
}
