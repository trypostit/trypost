 ...
 *   API", code 80005 "Instagram Platform". Unlike Platform Rate Limits, BUC
 *   rejections come back as an ordinary HTTP 400, not 429.
...
class GraphError
{
     ...
     */
    private const TRANSIENT_CODES = [1, 2, 4, 17, 80001, 80005];
