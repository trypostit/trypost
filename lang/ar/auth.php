...
return [
    ...
    */
    ...
    'social_email_unverified' => 'تعذر تأكيد بريدك الإلكتروني عبر :provider. أكّده هناك أو سجّل الدخول بالبريد الإلكتروني وكلمة المرور.',
    ...
    'register' => [
        ...
        'log_in' => 'تسجيل الدخول',
        'disposable_email' => 'يرجى استخدام عنوان بريد إلكتروني دائم. العناوين المؤقتة غير مقبولة.',
        'quota_reached' => 'تعذر إنشاء الحساب الآن. يرجى المحاولة لاحقًا.',
    ],
    ...
    'verify_email' => [
        ...
        'sent_to' => 'تم إرسال البريد إلى',
        'instructions' => 'تحقق من صندوق الوارد (ومن البريد العشوائي أيضًا). عليك تأكيد بريدك للمتابعة.',
        'wrong_email' => 'البريد غير صحيح؟ صححه',
        'new_email_label' => 'بريد إلكتروني جديد',
        'update_email' => 'حفظ وإعادة الإرسال',
        'cancel' => 'إلغاء',
    ],
