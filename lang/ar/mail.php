...
return [
    ...
    'post_at_risk' => [
        'subject' => '{1} منشور واحد معرض للخطر في :workspace|{2} منشوران معرضان للخطر في :workspace|[3,10] :count منشورات معرضة للخطر في :workspace|[11,*] :count منشورًا معرضًا للخطر في :workspace',
        'title' => 'منشورات قد تفشل في النشر',
        'intro' => 'تحتاج الحسابات الاجتماعية التالية في مساحة العمل <strong>:workspace</strong> إلى إعادة الربط قبل أن يتم نشر هذه المنشورات المجدولة:',
        'reconnect_cta' => 'يرجى إعادة ربط هذه الحسابات الآن لتجنب تفويت منشوراتك المجدولة.',
        'button' => 'إعادة ربط الحسابات',
        'posts_label' => '{1} 1 منشور مجدول: :times UTC|{2} منشوران مجدولان: :times UTC|[3,10] :count منشورات مجدولة: :times UTC|[11,*] :count منشورًا مجدولًا: :times UTC',
    ],
];
