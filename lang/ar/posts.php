...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'نص مخصص لـ :platform',
            'active' => 'مفعّل',
            'hint' => 'اتركه فارغًا لاستخدام نص المنشور المشترك.',
            'placeholder' => 'نص لهذه المنصة فقط…',
            'over_limit' => 'يتجاوز حد هذه المنصة (:limit حرفًا).',
        ],
        'location' => [
            'label' => 'الموقع',
            'id_placeholder' => 'معرّف المكان',
            'name_placeholder' => 'الاسم (للعرض)',
            'hint' => 'معرّف مكان فيسبوك؛ البحث عن الأماكن مغلق للتطبيقات الخارجية — أدخل المعرّف مرة واحدة وأعد استخدامه.',
        ],
        'youtube' => [
            ...
            'title' => 'العنوان',
            'title_placeholder' => 'عنوان الفيديو (بدل السطر الأول من المنشور)',
            'title_hint' => 'حتى 100 حرف؛ يُضاف " #Shorts" تلقائيًا عند اشتقاقه من النص.',
            'tags' => 'الوسوم',
            'tags_placeholder' => 'brisbane, pixel art, map',
            'tags_hint' => 'مفصولة بفواصل؛ تساعد البحث والتوصيات.',
