...
return [
    ...
    'publish_mode' => [
        'auto' => 'نشر تلقائي',
        'auto_hint' => 'يقوم TryPost بنشر هذا المنشور تلقائيًا في الوقت المحدد.',
        'manual' => 'أخطرني للنشر يدويًا',
        'manual_hint' => 'يذكرك TryPost عند الاستحقاق — وتنشره بنفسك.',
        'schedule_hint' => 'وضع النشر',
        'manual_notice' => 'سيتم إشعارك عند الاستحقاق وتنشره بنفسك من التطبيق.',
    ],
