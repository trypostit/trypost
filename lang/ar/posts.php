...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => 'أعد الصياغة',
        'assistant_shorten' => 'اختصر',
        'assistant_expand' => 'وسّع النص',
        'assistant_prompt_question' => 'عمّ تريد أن تكتب؟',
        'assistant_prompt_placeholder' => 'صف المنشور والجمهور والنتيجة المطلوبة.',
        'assistant_tip' => 'نصيحة: اذكر النقاط الأساسية والجمهور والنتيجة المطلوبة.',
        'assistant_generate' => 'إنشاء',
        'assistant_suggestion' => 'النص المقترح',
        'assistant_apply' => 'تطبيق على المنشور',
        'assistant_back' => 'رجوع',
        'assistant_error' => 'تعذر إنشاء اقتراح. حاول مرة أخرى.',
        'save_draft' => 'حفظ كمسودة',
        'create_another' => 'إنشاء منشور آخر',
        'templates' => 'القوالب',
        'expand' => 'توسيع النافذة',
        'post_previews' => 'معاينات المنشورات',
        'preview_empty' => 'معاينة منشورك ستظهر هنا',
        'select_all' => 'تحديد الكل',
        'deselect_all' => 'إلغاء تحديد الكل',
        'last_used' => 'آخر استخدام',
        'collapse' => 'تصغير النافذة',
        'now' => 'الآن',
        'now_description' => 'انشر منشورك فورًا.',
        'set_date_time' => 'تحديد التاريخ والوقت',
        'set_date_time_description' => 'اختر وقتًا محددًا للنشر.',
        'publish_now' => 'انشر الآن',
        'customize_networks' => 'تخصيص لكل شبكة',
        'use_shared' => 'استخدام المحتوى المشترك',
        'media_upload_failed' => 'تعذر رفع الوسائط. حاول مرة أخرى.',
        'crop_upload_failed' => 'تعذر رفع الصورة المقصوصة. ما زالت الصورة الأصلية محددة.',
    ],
