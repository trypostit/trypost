...
return [
    ...
    'workspace' => [
        ...
        'delete_description' => 'يحذف مساحة العمل هذه ومنشوراتها والحسابات المتصلة والوسائط نهائيًا. ستنخفض كمية اشتراكك بمقدار واحد.',
        'delete_description_self_hosted' => 'يحذف مساحة العمل هذه ومنشوراتها والحسابات المتصلة والوسائط نهائيًا.',
        'delete_only_description' => 'لا يمكنك حذف مساحة العمل الوحيدة لديك. ألغِ اشتراكك في إعدادات الفوترة لإغلاق حسابك.',
