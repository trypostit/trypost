...
return [
    ...
    'workspace' => [
        ...
        'timezone_auto' => 'تلقائي — منطقة المتصفح (:tz)',
        'timezone_description' => 'يُعرض التقويم والجدولة وتواريخ المنشورات بهذه المنطقة الزمنية لجميع أعضاء مساحة العمل.',
        'datetime_format' => 'تنسيق التاريخ والوقت',
        'datetime_format_auto' => 'تلقائي — حسب اللغة',
        'datetime_format_description' => 'يُطبَّق على التقويم وجميع قوائم المنشورات.',
        'save' => 'حفظ',
