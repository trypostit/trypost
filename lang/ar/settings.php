...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}سيفقد عضو آخر واحد الوصول وسيُحذف حساب TryPost الخاص به نهائيًا.|[2,*]سيفقد :count أعضاء آخرين الوصول وستُحذف حسابات TryPost الخاصة بهم نهائيًا.',
