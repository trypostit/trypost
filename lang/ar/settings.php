...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}سيفقد عضو آخر واحد الوصول إلى هذا الحساب وسيُنقل إلى حسابه الشخصي.|[2,*]سيفقد :count أعضاء آخرين الوصول إلى هذا الحساب وسيُنقلون إلى حساباتهم الشخصية.',
    ...
    'flash' => [
        ...
        'delete_failed_billing' => 'تعذّر إلغاء اشتراكك لدى مزود الفوترة. تمت إزالة مساحات العمل بالفعل، لكن لم يُحذف حسابك. يُرجى المحاولة مرة أخرى أو التواصل مع الدعم.',
