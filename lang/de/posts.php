...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Eigener Text für :platform',
            'active' => 'an',
            'hint' => 'Leer lassen, um den gemeinsamen Beitragstext zu verwenden.',
            'placeholder' => 'Text nur für diese Plattform…',
            'over_limit' => 'Länger als das Limit dieser Plattform (:limit Zeichen).',
        ],
        'location' => [
            'label' => 'Standort',
            'id_placeholder' => 'Orts-ID',
            'name_placeholder' => 'Name (zur Anzeige)',
            'hint' => 'Facebook-Orts-ID; die Ortssuche ist für Dritt-Apps geschlossen — ID einmal ermitteln und wiederverwenden.',
        ],
        'youtube' => [
            ...
            'title' => 'Titel',
            'title_placeholder' => 'Videotitel (statt der ersten Zeile des Beitrags)',
            'title_hint' => 'Bis zu 100 Zeichen; „ #Shorts" wird automatisch angehängt, wenn der Titel aus dem Text stammt.',
            'tags' => 'Tags',
            'tags_placeholder' => 'brisbane, pixel art, stadtkarte',
            'tags_hint' => 'Kommagetrennt; hilft Suche und Empfehlungen.',
