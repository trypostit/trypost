...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}:count weiteres Mitglied verliert den Zugriff auf dieses Konto.|[2,*]:count weitere Mitglieder verlieren den Zugriff auf dieses Konto.',
