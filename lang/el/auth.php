...
return [
    ...
    'password_strength' => [
        'length' => 'Τουλάχιστον 12 χαρακτήρες',
        'case' => 'Κεφαλαία και πεζά γράμματα',
        'number' => 'Τουλάχιστον ένας αριθμός',
        'symbol' => 'Τουλάχιστον ένα σύμβολο',
        'weak' => 'Αδύναμος',
        'fair' => 'Μέτριος',
        'good' => 'Καλός',
        'strong' => 'Ισχυρός',
    ...
    */
    ...
    'social_email_unverified' => 'Δεν μπορέσαμε να επιβεβαιώσουμε το email σας μέσω :provider. Επιβεβαιώστε το εκεί ή συνδεθείτε με email και κωδικό.',
    ...
    'register' => [
        ...
        'log_in' => 'Σύνδεση',
        'disposable_email' => 'Χρησιμοποιήστε μια μόνιμη διεύθυνση email. Οι προσωρινές διευθύνσεις δεν γίνονται δεκτές.',
        'quota_reached' => 'Δεν μπορέσαμε να δημιουργήσουμε τον λογαριασμό αυτή τη στιγμή. Δοκιμάστε ξανά αργότερα.',
    ],
    ...
    'verify_email' => [
        ...
        'log_out' => 'Αποσύνδεση',
        'sent_to' => 'Το email στάλθηκε στο',
        'instructions' => 'Ελέγξτε τα εισερχόμενά σας (και τα ανεπιθύμητα, για κάθε ενδεχόμενο). Πρέπει να επιβεβαιώσετε το email σας για να συνεχίσετε.',
        'wrong_email' => 'Λάθος email; Διορθώστε το',
        'new_email_label' => 'Νέο email',
        'update_email' => 'Αποθήκευση και επαναποστολή',
        'cancel' => 'Ακύρωση',
    ],
