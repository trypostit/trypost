...
return [
    ...
    'post_at_risk' => [
        'subject' => '{1} :count ανάρτηση κινδυνεύει στο :workspace|[2,*] :count αναρτήσεις κινδυνεύουν στο :workspace',
        'title' => 'Οι αναρτήσεις ενδέχεται να μη δημοσιευτούν',
        'intro' => 'Οι παρακάτω λογαριασμοί κοινωνικών δικτύων στο workspace <strong>:workspace</strong> πρέπει να επανασυνδεθούν πριν δημοσιευτούν αυτές οι προγραμματισμένες αναρτήσεις:',
        'reconnect_cta' => 'Παρακαλούμε επανασυνδέστε αυτούς τους λογαριασμούς τώρα για να μη χάσετε τις προγραμματισμένες σας αναρτήσεις.',
        'button' => 'Επανασύνδεση λογαριασμών',
        'posts_label' => '{1} 1 προγραμματισμένη ανάρτηση: :times UTC|[2,*] :count προγραμματισμένες αναρτήσεις: :times UTC',
    ],
];
