...
return [
    ...
    'connected_description' => 'Βοηθοί με σύνδεση από οποιονδήποτε σε αυτόν τον λογαριασμό. Μπορείτε να αποσυνδέσετε μόνο τους δικούς σας.',
    'connected_empty' => 'Τίποτα συνδεδεμένο ακόμα. Χρησιμοποιήστε Claude, ChatGPT ή άλλο client παραπάνω.',
    'connected_by' => 'Συνδέθηκε από :name',
