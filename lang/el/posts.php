...
return [
    ...
    'composer' => [
        'load_failed' => 'Δεν ήταν δυνατή η φόρτωση του επεξεργαστή δημοσιεύσεων.',
        'retry' => 'Δοκιμάστε ξανά',
        'assistant_title' => 'Βοηθός AI',
        'assistant_question' => 'Πώς μπορώ να βοηθήσω με αυτή τη δημοσίευση;',
        'assistant_write_more' => 'Γράψε περισσότερα',
        'assistant_rephrase' => 'Αναδιατύπωση',
        'assistant_shorten' => 'Συντόμευση',
        'assistant_expand' => 'Ανάπτυξη',
        'assistant_prompt_question' => 'Για τι θέλετε να γράψετε;',
        'assistant_prompt_placeholder' => 'Περιγράψτε τη δημοσίευση, το κοινό και το επιθυμητό αποτέλεσμα.',
        'assistant_tip' => 'Συμβουλή: συμπεριλάβετε τα βασικά σημεία, το κοινό και το επιθυμητό αποτέλεσμα.',
        'assistant_generate' => 'Δημιουργία',
        'assistant_suggestion' => 'Προτεινόμενο κείμενο',
        'assistant_apply' => 'Εφαρμογή στη δημοσίευση',
        'assistant_back' => 'Πίσω',
        'assistant_error' => 'Δεν ήταν δυνατή η δημιουργία πρότασης. Δοκιμάστε ξανά.',
        'save_draft' => 'Αποθήκευση ως πρόχειρο',
        'create_another' => 'Δημιουργία άλλου',
        'templates' => 'Πρότυπα',
        'expand' => 'Μεγέθυνση διαλόγου',
        'post_previews' => 'Προεπισκοπήσεις αναρτήσεων',
        'preview_empty' => 'Η προεπισκόπηση της ανάρτησής σας θα εμφανιστεί εδώ',
        'select_all' => 'Επιλογή όλων',
        'deselect_all' => 'Αποεπιλογή όλων',
        'last_used' => 'Πρόσφατα χρησιμοποιημένα',
        'collapse' => 'Σμίκρυνση διαλόγου',
        'now' => 'Τώρα',
        'now_description' => 'Δημοσίευσε αμέσως.',
        'set_date_time' => 'Ορισμός ημερομηνίας και ώρας',
        'set_date_time_description' => 'Επίλεξε συγκεκριμένη ώρα δημοσίευσης.',
        'publish_now' => 'Δημοσίευση τώρα',
        'customize_networks' => 'Προσαρμογή ανά δίκτυο',
        'use_shared' => 'Χρήση κοινόχρηστου περιεχομένου',
        'media_upload_failed' => 'Δεν ήταν δυνατή η μεταφόρτωση των πολυμέσων. Δοκιμάστε ξανά.',
        'crop_upload_failed' => 'Δεν ήταν δυνατή η μεταφόρτωση της περικομμένης εικόνας. Η αρχική παραμένει επιλεγμένη.',
    ],
    ...
    'form' => [
        ...
        'google_business' => [
            ...
            'cta_url_required' => 'Εισάγετε έναν σύνδεσμο για αυτό το κουμπί ή επιλέξτε "Κανένα".',
            'event_title' => 'Τίτλος εκδήλωσης',
            'event_title_placeholder' => 'Ο τίτλος της εκδήλωσής σας',
            'event_title_required' => 'Εισάγετε τίτλο εκδήλωσης.',
            'event_start_date' => 'Έναρξη',
            'event_start_date_required' => 'Εισάγετε ημερομηνία έναρξης.',
            'event_end_date' => 'Λήξη',
            'event_end_date_required' => 'Εισάγετε ημερομηνία λήξης.',
            'event_end_date_before_start' => 'Η ημερομηνία λήξης πρέπει να είναι ίδια ή μεταγενέστερη της ημερομηνίας έναρξης.',
            'event_end_time_before_start' => 'Η ώρα λήξης πρέπει να είναι μετά την ώρα έναρξης.',
            'title_max' => 'Ο τίτλος πρέπει να έχει έως 58 χαρακτήρες.',
            'event_start_time' => 'Ώρα έναρξης',
            'event_end_time' => 'Ώρα λήξης',
            'offer_title' => 'Τίτλος προσφοράς',
            'offer_title_placeholder' => 'Εισάγετε έναν τίτλο για την προσφορά σας',
            'offer_title_required' => 'Εισάγετε τίτλο προσφοράς.',
            'offer_coupon_code' => 'Κωδικός κουπονιού',
            'offer_redeem_url' => 'Σύνδεσμος προσφοράς',
            'offer_terms' => 'Όροι και προϋποθέσεις',
            'event_times_use_location' => 'Οι ώρες ακολουθούν την τοπική ώρα της τοποθεσίας, όχι του προγράμματος περιήγησης.',
        ],
        'warnings' => [
    ...
    'show' => [
        ...
        'pending_review' => 'Η Google εξετάζει αυτή την ανάρτηση. Θα την ενημερώσουμε όταν ολοκληρωθεί ο έλεγχος.',
    ],
    ...
    'errors' => [
        ...
        'target_disabled' => 'Αυτός ο προορισμός απενεργοποιήθηκε',
        ...
        'google_business' => [
            'no_location' => 'Αυτός ο λογαριασμός Google Business Profile δεν έχει ρυθμισμένη τοποθεσία. Σύνδεσέ τον ξανά.',
            'permission_denied' => 'Άρνηση πρόσβασης. Σύνδεσε ξανά και επιβεβαίωσε την πρόσβαση σε αυτή την τοποθεσία.',
            'not_found' => 'Η τοποθεσία δεν βρέθηκε. Μπορεί να διαγράφηκε — σύνδεσε ξανά τον λογαριασμό.',
            'invalid_content' => 'Μη έγκυρο περιεχόμενο. Έλεγξε τα στοιχεία της ανάρτησης.',
            'rate_limited' => 'Ξεπεράστηκε το όριο αιτημάτων. Δοκίμασε ξανά αργότερα.',
            'server_error' => 'Σφάλμα διακομιστή του Google Business Profile. Δοκίμασε ξανά.',
            'rejected' => 'Το Google Business Profile απέρριψε αυτή την ανάρτηση. Δοκίμασε ξανά.',
            'event_dates_required' => 'Αυτή η ανάρτηση χρειάζεται ημερομηνία έναρξης και λήξης. Πρόσθεσέ τις και δοκίμασε ξανά.',
            'token_expired' => 'Το διακριτικό πρόσβασης του Google Business Profile είναι άκυρο ή έχει λήξει',
            'no_refresh_token' => 'Δεν υπάρχει refresh token για τον λογαριασμό Google Business Profile',
        ],
    ],
