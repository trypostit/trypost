...
return [
    ...
    'publish_mode' => [
        'auto' => 'Αυτόματη δημοσίευση',
        'auto_hint' => 'Το TryPost δημοσιεύει αυτόματα αυτή τη δημοσίευση την προγραμματισμένη ώρα.',
        'manual' => 'Να με ειδοποιήσετε για χειροκίνητη δημοσίευση',
        'manual_hint' => 'Το TryPost σας υπενθυμίζει πότε είναι έτοιμο — δημοσιεύετε εσείς.',
        'schedule_hint' => 'Τρόπος δημοσίευσης',
        'manual_notice' => 'Θα ειδοποιηθείτε όταν είναι έτοιμο και θα το δημοσιεύσετε από την εφαρμογή.',
    ],
