...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Ξεχωριστό κείμενο για :platform',
            'active' => 'ενεργό',
            'hint' => 'Κενό: χρησιμοποιείται το κοινό κείμενο της ανάρτησης.',
            'placeholder' => 'Κείμενο μόνο για αυτήν την πλατφόρμα…',
            'over_limit' => 'Υπερβαίνει το όριο της πλατφόρμας (:limit χαρακτήρες).',
        ],
        'location' => [
            'label' => 'Τοποθεσία',
            'id_placeholder' => 'ID τοποθεσίας',
            'name_placeholder' => 'Όνομα (εμφάνιση)',
            'hint' => 'Facebook place ID· η αναζήτηση τοποθεσιών είναι κλειστή για τρίτους — βρείτε το ID μία φορά και επαναχρησιμοποιήστε το.',
        ],
        'youtube' => [
            ...
            'title' => 'Τίτλος',
            'title_placeholder' => 'Τίτλος βίντεο (αντί της πρώτης γραμμής)',
            'title_hint' => 'Έως 100 χαρακτήρες· το " #Shorts" προστίθεται αυτόματα όταν προκύπτει από το κείμενο.',
            'tags' => 'Ετικέτες',
            'tags_placeholder' => 'brisbane, pixel art, map',
            'tags_hint' => 'Χωρισμένες με κόμματα· βοηθούν αναζήτηση και προτάσεις.',
            'category' => 'ID κατηγορίας',
            'language' => 'Γλώσσα',
            'location' => 'Τοποθεσία λήψης',
            'location_placeholder' => 'Brisbane QLD',
            'lat' => 'Γεωγρ. πλάτος',
            'lng' => 'Γεωγρ. μήκος',
        ],
        'first_comment' => [
