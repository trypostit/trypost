...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}:count άλλο μέλος θα χάσει την πρόσβαση σε αυτόν τον λογαριασμό.|[2,*]:count άλλα μέλη θα χάσουν την πρόσβαση σε αυτόν τον λογαριασμό.',
