...
return [
    ...
    'workspace' => [
        ...
        'timezone' => 'Ζώνη ώρας',
        'timezone_auto' => 'Αυτόματα — ζώνη του προγράμματος περιήγησης (:tz)',
        'timezone_description' => 'Το ημερολόγιο, ο προγραμματισμός και οι ημερομηνίες αναρτήσεων εμφανίζονται σε αυτήν τη ζώνη για όλο το workspace.',
        'datetime_format' => 'Μορφή ημερομηνίας και ώρας',
        'datetime_format_auto' => 'Αυτόματα — προεπιλογή γλώσσας',
        'datetime_format_description' => 'Εφαρμόζεται στο ημερολόγιο και σε όλες τις λίστες αναρτήσεων.',
        'save' => 'Αποθήκευση',
