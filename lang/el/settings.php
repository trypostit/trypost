...
return [
    ...
    'flash' => [
        ...
        'delete_failed_billing' => 'Δεν μπορέσαμε να ακυρώσουμε τη συνδρομή σας στον πάροχο χρέωσης. Δοκιμάστε ξανά ή επικοινωνήστε με την υποστήριξη. Ο λογαριασμός σας δεν διαγράφηκε.',
