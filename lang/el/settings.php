...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}:count άλλο μέλος θα χάσει την πρόσβαση σε αυτόν τον λογαριασμό και θα μεταφερθεί στον προσωπικό του λογαριασμό.|[2,*]:count άλλα μέλη θα χάσουν την πρόσβαση σε αυτόν τον λογαριασμό και θα μεταφερθούν στους προσωπικούς τους λογαριασμούς.',
    ...
    'flash' => [
        ...
        'delete_failed_billing' => 'Δεν μπορέσαμε να ακυρώσουμε τη συνδρομή σας στον πάροχο χρέωσης. Οι χώροι εργασίας σας έχουν ήδη αφαιρεθεί, αλλά ο λογαριασμός σας όχι. Δοκιμάστε ξανά ή επικοινωνήστε με την υποστήριξη.',
