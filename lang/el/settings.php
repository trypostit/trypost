...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}:count άλλο μέλος θα χάσει την πρόσβαση και ο λογαριασμός TryPost θα διαγραφεί οριστικά.|[2,*]:count άλλα μέλη θα χάσουν την πρόσβαση και οι λογαριασμοί TryPost θα διαγραφούν οριστικά.',
