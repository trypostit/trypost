...
return [
    ...
    'back' => 'Πίσω',
    'steps' => [
        'persona' => 'Σχετικά με εσάς',
        'goals' => 'Οι στόχοι σας',
        'referral_source' => 'Πώς μας βρήκατε',
        'connect' => 'Κοινωνικά δίκτυα',
        'plan' => 'Πλάνο',
    ],
    'preview' => [
    ...
    'goals' => [
        ...
        'use_mcp' => 'Δημιουργία δημοσιεύσεων από Claude, ChatGPT κ.λπ.',
    ...
    'plan_title' => 'Επιλέξτε το πλάνο σας',
    'plan_description' => 'Και τα δύο πλάνα περιλαμβάνουν όλες τις λειτουργίες και όλα τα κοινωνικά δίκτυα. Η μόνη διαφορά είναι πόσα workspaces έχετε — αλλάξτε όποτε θέλετε.',
