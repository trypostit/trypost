...
return [
    ...
    'connect_title' => 'Σύνδεσε έναν λογαριασμό κοινωνικής δικτύωσης',
    'connect_description' => 'Επίλεξε τουλάχιστον ένα δίκτυο όπου το TryPost μπορεί να δημοσιεύει το περιεχόμενό σου. Μπορείς να συνεχίσεις και να το κάνεις αργότερα.',
];
