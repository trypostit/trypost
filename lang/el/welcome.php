...
return [
    ...
    'plan_title' => 'Επιλέξτε πλάνο. Όλα τα χαρακτηριστικά περιλαμβάνονται.',
    'plan_description' => 'Η μόνη διαφορά είναι πόσα workspaces παίρνετε. Μπορείτε να αλλάξετε αργότερα.',
