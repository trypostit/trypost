...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => 'Rephrase',
        'assistant_shorten' => 'Shorten',
        'assistant_expand' => 'Expand',
        'assistant_prompt_question' => 'What do you want to write about?',
        'assistant_prompt_placeholder' => 'Describe your post, audience, and desired outcome.',
        'assistant_tip' => 'Tip: Include key points, your audience, and the desired outcome.',
        'assistant_generate' => 'Generate',
        'assistant_suggestion' => 'Suggested caption',
        'assistant_apply' => 'Apply to post',
        'assistant_back' => 'Back',
        'assistant_error' => 'Could not generate a suggestion. Please try again.',
        'save_draft' => 'Save draft',
        'create_another' => 'Create another',
        'templates' => 'Templates',
        'expand' => 'Expand dialog',
        'post_previews' => 'Post previews',
        'preview_empty' => 'Your post preview will appear here.',
        'select_all' => 'Select all',
        'deselect_all' => 'Deselect all',
        'last_used' => 'Last used',
        'collapse' => 'Exit full screen',
        'now' => 'Now',
        'now_description' => 'Publish your post right away.',
        'set_date_time' => 'Set date and time',
        'set_date_time_description' => 'Choose a specific time to publish.',
        'publish_now' => 'Publish now',
        'customize_networks' => 'Customize for each network',
        'use_shared' => 'Use shared content',
        'media_upload_failed' => 'Could not upload the media. Please try again.',
