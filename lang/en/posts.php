...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Custom text for :platform',
            'active' => 'on',
            'hint' => 'Leave empty to use the shared post text.',
            'placeholder' => 'Text for this platform only…',
            'over_limit' => 'Longer than this platform allows (:limit characters).',
        ],
        'location' => [
            'label' => 'Location',
            'id_placeholder' => 'Place ID',
            'name_placeholder' => 'Name (for display)',
            'hint' => 'Facebook place ID; place search is closed to third-party apps, so enter the ID once and reuse it.',
        ],
        'youtube' => [
            ...
            'title' => 'Title',
            'title_placeholder' => 'Video title (instead of the first line of the post)',
            'title_hint' => 'Up to 100 characters; " #Shorts" is appended automatically when derived from the post text.',
            'tags' => 'Tags',
            'tags_placeholder' => 'brisbane, pixel art, city map',
            'tags_hint' => 'Comma-separated; helps search and recommendations.',
