...
return [
    ...
    'workspace' => [
        ...
        'timezone' => 'Timezone',
        'timezone_auto' => 'Auto — browser timezone (:tz)',
        'timezone_description' => 'Calendar, schedule and post dates are shown in this timezone for everyone in the workspace.',
        'datetime_format' => 'Date & time format',
        'datetime_format_auto' => 'Auto — language default',
        'datetime_format_description' => 'Applied to the calendar and all post lists.',
        'save' => 'Save',
