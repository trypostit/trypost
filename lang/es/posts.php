...
return [
    ...
    'new_post' => 'Nuevo post',
    'composer' => [
        'load_failed' => 'No se pudo cargar el editor de publicaciones.',
        'retry' => 'Intentar de nuevo',
        'assistant_title' => 'Asistente de IA',
        'assistant_question' => '¿Cómo puedo ayudarte con esta publicación?',
        'assistant_write_more' => 'Escribir más',
        'assistant_rephrase' => 'Reformular',
        'assistant_shorten' => 'Acortar',
        'assistant_expand' => 'Ampliar',
        'assistant_prompt_question' => '¿Sobre qué quieres escribir?',
        'assistant_prompt_placeholder' => 'Describe tu publicación, tu audiencia y el resultado deseado.',
        'assistant_tip' => 'Consejo: incluye los puntos clave, tu audiencia y el resultado deseado.',
        'assistant_generate' => 'Generar',
        'assistant_suggestion' => 'Texto sugerido',
        'assistant_apply' => 'Aplicar a la publicación',
        'assistant_back' => 'Volver',
        'assistant_error' => 'No se pudo generar una sugerencia. Inténtalo de nuevo.',
        'save_draft' => 'Guardar borrador',
        'create_another' => 'Crear otro',
        'templates' => 'Plantillas',
        'expand' => 'Ampliar diálogo',
        'post_previews' => 'Vistas previas de posts',
        'preview_empty' => 'La vista previa de tu publicación aparecerá aquí',
        'select_all' => 'Seleccionar todos',
        'deselect_all' => 'Deseleccionar todos',
        'last_used' => 'Últimos usados',
        'collapse' => 'Salir de pantalla completa',
        'now' => 'Ahora',
        'now_description' => 'Publica tu post de inmediato.',
        'set_date_time' => 'Definir fecha y hora',
        'set_date_time_description' => 'Elige un momento concreto para publicar.',
        'publish_now' => 'Publicar ahora',
        'customize_networks' => 'Personalizar para cada red',
        'use_shared' => 'Usar contenido compartido',
        'media_upload_failed' => 'No se pudieron subir los archivos. Inténtalo de nuevo.',
        'crop_upload_failed' => 'No se pudo subir la imagen recortada. La original sigue seleccionada.',
    ],
    ...
    'form' => [
        ...
        'google_business' => [
            ...
            'cta_url_required' => 'Ingresa un enlace para este botón, o elige "Ninguno".',
            'event_title' => 'Título del evento',
            'event_title_placeholder' => 'El título de tu evento',
            ...
            'title_max' => 'El título no puede superar los 58 caracteres.',
            'event_start_time' => 'Hora de inicio',
            'event_end_time' => 'Hora de finalización',
            'offer_title' => 'Título de la oferta',
            'offer_title_placeholder' => 'Ingresa un título para tu oferta',
            'offer_title_required' => 'Ingresa un título de oferta.',
    ...
    'errors' => [
        ...
        'google_business' => [
            ...
            'not_found' => 'Ubicación no encontrada. Puede que se haya eliminado — reconecta la cuenta.',
            'invalid_content' => 'Contenido no válido. Revisa los detalles de la publicación.',
            'rate_limited' => 'Se superó el límite de solicitudes. Inténtalo de nuevo más tarde.',
            'server_error' => 'Error del servidor de Google Business Profile. Inténtalo de nuevo.',
            'rejected' => 'Google Business Profile rechazó esta publicación. Inténtalo de nuevo.',
            'event_dates_required' => 'Esta publicación necesita una fecha de inicio y de fin. Añádelas e inténtalo de nuevo.',
            'token_expired' => 'El token de acceso de Google Business Profile no es válido o ha caducado',
            'no_refresh_token' => 'No hay refresh token disponible para la cuenta de Google Business Profile',
        ],
    ],
