...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Texto propio para :platform',
            'active' => 'sí',
            'hint' => 'Vacío: se usa el texto común de la publicación.',
            'placeholder' => 'Texto solo para esta plataforma…',
            'over_limit' => 'Supera el límite de esta plataforma (:limit caracteres).',
        ],
        'location' => [
            'label' => 'Ubicación',
            'id_placeholder' => 'ID del lugar',
            'name_placeholder' => 'Nombre (visual)',
            'hint' => 'ID de lugar de Facebook; la búsqueda de lugares está cerrada a terceros: introduce el ID una vez y reutilízalo.',
        ],
        'youtube' => [
            ...
            'title' => 'Título',
            'title_placeholder' => 'Título del vídeo (en lugar de la primera línea)',
            'title_hint' => 'Hasta 100 caracteres; " #Shorts" se añade automáticamente si se deriva del texto.',
            'tags' => 'Etiquetas',
            'tags_placeholder' => 'brisbane, pixel art, mapa',
            'tags_hint' => 'Separadas por comas; ayudan a la búsqueda y recomendaciones.',
            'category' => 'ID de categoría',
            'language' => 'Idioma',
            'location' => 'Lugar de grabación',
