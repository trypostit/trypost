...
return [
    ...
    'workspace' => [
        ...
        'timezone_auto' => 'Auto — zona del navegador (:tz)',
        'timezone_description' => 'El calendario, la programación y las fechas de publicaciones se muestran en esta zona para todo el workspace.',
        'datetime_format' => 'Formato de fecha y hora',
        'datetime_format_auto' => 'Auto — según el idioma',
        'datetime_format_description' => 'Se aplica al calendario y a todas las listas de publicaciones.',
        'save' => 'Guardar',
