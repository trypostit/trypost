...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Texte spécifique pour :platform',
            'active' => 'actif',
            'hint' => 'Vide : le texte commun de la publication est utilisé.',
            'placeholder' => 'Texte pour cette plateforme uniquement…',
            'over_limit' => 'Dépasse la limite de cette plateforme (:limit caractères).',
        ],
        'location' => [
            'label' => 'Lieu',
            'id_placeholder' => 'ID du lieu',
            'name_placeholder' => 'Nom (affichage)',
            'hint' => 'ID de lieu Facebook ; la recherche de lieux est fermée aux apps tierces — saisissez l’ID une fois et réutilisez-le.',
        ],
        'youtube' => [
            ...
            'title' => 'Titre',
            'title_placeholder' => 'Titre de la vidéo (au lieu de la première ligne)',
            'title_hint' => 'Jusqu’à 100 caractères ; « #Shorts » est ajouté automatiquement s’il provient du texte.',
            'tags' => 'Tags',
            'tags_placeholder' => 'brisbane, pixel art, carte',
            'tags_hint' => 'Séparés par des virgules ; aide la recherche et les recommandations.',
