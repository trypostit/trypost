...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => 'Reformuler',
        'assistant_shorten' => 'Raccourcir',
        'assistant_expand' => 'Développer',
        'assistant_prompt_question' => 'Sur quoi souhaitez-vous écrire ?',
        'assistant_prompt_placeholder' => 'Décrivez votre publication, votre public et le résultat souhaité.',
        'assistant_tip' => 'Conseil : indiquez les points clés, votre public et le résultat souhaité.',
        'assistant_generate' => 'Générer',
        'assistant_suggestion' => 'Texte proposé',
        'assistant_apply' => 'Appliquer à la publication',
        'assistant_back' => 'Retour',
        'assistant_error' => 'Impossible de générer une suggestion. Veuillez réessayer.',
        'save_draft' => 'Enregistrer le brouillon',
        'create_another' => 'En créer un autre',
        'templates' => 'Modèles',
        'expand' => 'Agrandir la fenêtre',
        'post_previews' => 'Aperçus des publications',
        'preview_empty' => 'L’aperçu de votre publication apparaîtra ici',
        'select_all' => 'Tout sélectionner',
        'deselect_all' => 'Tout désélectionner',
        'last_used' => 'Récemment utilisés',
        'collapse' => 'Quitter le plein écran',
        'now' => 'Maintenant',
        'now_description' => 'Publiez immédiatement.',
        'set_date_time' => 'Définir la date et l’heure',
        'set_date_time_description' => 'Choisissez une heure précise pour publier.',
        'publish_now' => 'Publier maintenant',
        'customize_networks' => 'Personnaliser par réseau',
        'use_shared' => 'Utiliser le contenu commun',
        'media_upload_failed' => 'Impossible d’envoyer les médias. Veuillez réessayer.',
