...
return [
    ...
    'workspace' => [
        ...
        'timezone_auto' => 'Auto — fuseau du navigateur (:tz)',
        'timezone_description' => 'Le calendrier, la planification et les dates des publications s’affichent dans ce fuseau pour tout le workspace.',
        'datetime_format' => 'Format de date et d’heure',
        'datetime_format_auto' => 'Auto — selon la langue',
        'datetime_format_description' => 'Appliqué au calendrier et à toutes les listes de publications.',
        'save' => 'Enregistrer',
