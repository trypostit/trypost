...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => '言い換える',
        'assistant_shorten' => '短くする',
        'assistant_expand' => '詳しくする',
        'assistant_prompt_question' => '何について書きたいですか？',
        'assistant_prompt_placeholder' => '投稿の内容、対象読者、伝えたい結果を入力してください。',
        'assistant_tip' => 'ヒント：要点、対象読者、伝えたい結果を含めてください。',
        'assistant_generate' => '生成する',
        'assistant_suggestion' => '提案された文章',
        'assistant_apply' => '投稿に反映',
        'assistant_back' => '戻る',
        'assistant_error' => '提案を生成できませんでした。もう一度お試しください。',
        'save_draft' => '下書きを保存',
        'create_another' => '続けて作成',
        'templates' => 'テンプレート',
        'expand' => 'ダイアログを拡大',
        'post_previews' => '投稿プレビュー',
        'preview_empty' => '投稿のプレビューがここに表示されます',
        'select_all' => 'すべて選択',
        'deselect_all' => 'すべて選択解除',
        'last_used' => '最近使用',
        'collapse' => '全画面表示を終了',
        'now' => '今すぐ',
        'now_description' => '投稿をすぐに公開します。',
        'set_date_time' => '日時を設定',
        'set_date_time_description' => '公開する日時を選択します。',
        'publish_now' => '今すぐ公開',
        'customize_networks' => 'ネットワークごとにカスタマイズ',
        'use_shared' => '共通の内容を使用',
        'media_upload_failed' => 'メディアをアップロードできませんでした。もう一度お試しください。',
