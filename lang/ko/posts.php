...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => '다시 표현하기',
        'assistant_shorten' => '짧게 줄이기',
        'assistant_expand' => '내용 늘리기',
        'assistant_prompt_question' => '무엇에 대해 쓰고 싶으신가요?',
        'assistant_prompt_placeholder' => '게시물 내용, 대상 독자, 원하는 결과를 설명해 주세요.',
        'assistant_tip' => '팁: 핵심 내용, 대상 독자, 원하는 결과를 포함하세요.',
        'assistant_generate' => '생성',
        'assistant_suggestion' => '제안된 문구',
        'assistant_apply' => '게시물에 적용',
        'assistant_back' => '뒤로',
        'assistant_error' => '제안을 생성하지 못했습니다. 다시 시도해 주세요.',
        'save_draft' => '초안 저장',
        'create_another' => '하나 더 만들기',
        'templates' => '템플릿',
        'expand' => '대화 상자 확장',
        'post_previews' => '게시물 미리보기',
        'preview_empty' => '게시물 미리보기가 여기에 표시됩니다',
        'select_all' => '모두 선택',
        'deselect_all' => '모두 선택 해제',
        'last_used' => '최근 사용',
        'collapse' => '전체 화면 종료',
        'now' => '지금',
        'now_description' => '게시물을 즉시 발행합니다.',
        'set_date_time' => '날짜 및 시간 설정',
        'set_date_time_description' => '발행할 시간을 선택하세요.',
        'publish_now' => '지금 발행',
        'customize_networks' => '네트워크별 맞춤 설정',
        'use_shared' => '공통 콘텐츠 사용',
        'media_upload_failed' => '미디어를 업로드하지 못했습니다. 다시 시도해 주세요.',
    ...
    'form' => [
        ...
        'google_business' => [
            ...
            'cta_url_required' => '이 버튼의 링크를 입력하거나 "없음"을 선택하세요.',
            'event_title' => '이벤트 제목',
            'event_title_placeholder' => '이벤트 제목을 입력하세요',
            ...
            'offer_title' => '오퍼 제목',
            'offer_title_placeholder' => '오퍼 제목을 입력하세요',
            'offer_title_required' => '오퍼 제목을 입력하세요.',
    ...
    'errors' => [
        ...
        'google_business' => [
            ...
            'not_found' => '위치를 찾을 수 없습니다. 삭제되었을 수 있습니다. 다시 연결하세요.',
            'invalid_content' => '게시물 내용이 올바르지 않습니다. 세부 정보를 확인하세요.',
            'rate_limited' => '요청 한도를 초과했습니다. 나중에 다시 시도하세요.',
            'server_error' => 'Google 비즈니스 프로필 서버 오류입니다. 다시 시도하세요.',
            'rejected' => 'Google 비즈니스 프로필이 이 게시물을 거부했습니다. 다시 시도하세요.',
            'event_dates_required' => '이 게시물에는 시작일과 종료일이 필요합니다. 추가한 후 다시 시도하세요.',
            'token_expired' => 'Google 비즈니스 프로필 액세스 토큰이 유효하지 않거나 만료되었습니다',
            'no_refresh_token' => 'Google 비즈니스 프로필 계정에 사용할 새로고침 토큰이 없습니다',
        ],
    ],
