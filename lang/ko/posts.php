...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => ':platform 전용 텍스트',
            'active' => '사용',
            'hint' => '비워두면 게시물의 공통 텍스트가 사용됩니다.',
            'placeholder' => '이 플랫폼만을 위한 텍스트…',
            'over_limit' => '이 플랫폼의 한도(:limit자)를 초과했습니다.',
        ],
        'location' => [
            'label' => '위치',
            'id_placeholder' => '장소 ID',
            'name_placeholder' => '이름(표시용)',
            'hint' => 'Facebook 장소 ID. 장소 검색은 서드파티에 닫혀 있으므로 ID를 한 번 찾아 재사용하세요.',
        ],
        'youtube' => [
            'settings' => 'YouTube 설정',
            'posting_to' => '게시 위치',
            ...
            'title' => '제목',
            'title_placeholder' => '동영상 제목(게시물 첫 줄 대신)',
            'title_hint' => '최대 100자. 본문에서 생성되면 " #Shorts"가 자동으로 붙습니다.',
            'tags' => '태그',
            'tags_placeholder' => 'brisbane, pixel art, map',
            'tags_hint' => '쉼표로 구분. 검색과 추천에 도움이 됩니다.',
            'category' => '카테고리 ID',
            'language' => '언어',
            'location' => '촬영 위치',
