...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => 'Herformuleren',
        'assistant_shorten' => 'Inkorten',
        'assistant_expand' => 'Uitbreiden',
        'assistant_prompt_question' => 'Waarover wil je schrijven?',
        'assistant_prompt_placeholder' => 'Beschrijf je bericht, doelgroep en gewenste resultaat.',
        'assistant_tip' => 'Tip: vermeld de belangrijkste punten, je doelgroep en het gewenste resultaat.',
        'assistant_generate' => 'Genereren',
        'assistant_suggestion' => 'Voorgestelde tekst',
        'assistant_apply' => 'Toepassen op bericht',
        'assistant_back' => 'Terug',
        'assistant_error' => 'Er kon geen voorstel worden gemaakt. Probeer het opnieuw.',
        'save_draft' => 'Concept opslaan',
        'create_another' => 'Nog een maken',
        'templates' => 'Sjablonen',
        'expand' => 'Venster vergroten',
        'post_previews' => 'Berichtvoorbeelden',
        'preview_empty' => 'Je berichtvoorbeeld verschijnt hier',
        'select_all' => 'Alles selecteren',
        'deselect_all' => 'Alles deselecteren',
        'last_used' => 'Recent gebruikt',
        'collapse' => 'Volledig scherm sluiten',
        'now' => 'Nu',
        'now_description' => 'Publiceer je bericht meteen.',
        'set_date_time' => 'Datum en tijd instellen',
        'set_date_time_description' => 'Kies een specifiek publicatiemoment.',
        'publish_now' => 'Nu publiceren',
        'customize_networks' => 'Per netwerk aanpassen',
        'use_shared' => 'Gedeelde inhoud gebruiken',
        'media_upload_failed' => 'Media konden niet worden geüpload. Probeer het opnieuw.',
