...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Eigen tekst voor :platform',
            'active' => 'aan',
            'hint' => 'Leeg: de gedeelde berichttekst wordt gebruikt.',
            'placeholder' => 'Tekst alleen voor dit platform…',
            'over_limit' => 'Langer dan de limiet van dit platform (:limit tekens).',
        ],
        'location' => [
            'label' => 'Locatie',
            'id_placeholder' => 'Plaats-ID',
            'name_placeholder' => 'Naam (weergave)',
            'hint' => 'Facebook-plaats-ID; plaats zoeken is gesloten voor externe apps — voer de ID één keer in en hergebruik.',
        ],
        'youtube' => [
            ...
            'title' => 'Titel',
            'title_placeholder' => 'Videotitel (in plaats van de eerste regel)',
            'title_hint' => 'Tot 100 tekens; " #Shorts" wordt automatisch toegevoegd als de titel uit de tekst komt.',
            'tags' => 'Tags',
            'tags_placeholder' => 'brisbane, pixel art, kaart',
            'tags_hint' => 'Kommagescheiden; helpt zoeken en aanbevelingen.',
