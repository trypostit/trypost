...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Własny tekst dla :platform',
            'active' => 'wł.',
            'hint' => 'Puste — używany jest wspólny tekst posta.',
            'placeholder' => 'Tekst tylko dla tej platformy…',
            'over_limit' => 'Przekracza limit tej platformy (:limit znaków).',
        ],
        'location' => [
            'label' => 'Lokalizacja',
            'id_placeholder' => 'ID miejsca',
            'name_placeholder' => 'Nazwa (podgląd)',
            'hint' => 'ID miejsca Facebooka; wyszukiwanie miejsc jest zamknięte dla aplikacji zewnętrznych — wpisz ID raz i używaj ponownie.',
        ],
        'youtube' => [
            ...
            'title' => 'Tytuł',
            'title_placeholder' => 'Tytuł filmu (zamiast pierwszej linii posta)',
            'title_hint' => 'Do 100 znaków; „ #Shorts" dodawane automatycznie, gdy tytuł pochodzi z tekstu.',
            'tags' => 'Tagi',
            'tags_placeholder' => 'brisbane, pixel art, mapa',
            'tags_hint' => 'Rozdzielone przecinkami; pomagają wyszukiwarce i rekomendacjom.',
