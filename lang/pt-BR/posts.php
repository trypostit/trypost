...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => 'Texto próprio para :platform',
            'active' => 'ativo',
            'hint' => 'Vazio: o texto comum da publicação é usado.',
            'placeholder' => 'Texto apenas para esta plataforma…',
            'over_limit' => 'Excede o limite desta plataforma (:limit caracteres).',
        ],
        'location' => [
            'label' => 'Localização',
            'id_placeholder' => 'ID do lugar',
            'name_placeholder' => 'Nome (exibição)',
            'hint' => 'ID de lugar do Facebook; a busca de lugares está fechada para terceiros — informe o ID uma vez e reutilize.',
        ],
        'youtube' => [
            ...
            'title' => 'Título',
            'title_placeholder' => 'Título do vídeo (em vez da primeira linha)',
            'title_hint' => 'Até 100 caracteres; " #Shorts" é adicionado automaticamente quando derivado do texto.',
            'tags' => 'Tags',
            'tags_placeholder' => 'brisbane, pixel art, mapa',
            'tags_hint' => 'Separadas por vírgulas; ajudam busca e recomendações.',
            'category' => 'ID da categoria',
            'language' => 'Idioma',
            'location' => 'Local de gravação',
