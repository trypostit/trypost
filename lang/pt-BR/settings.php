...
return [
    ...
    'workspace' => [
        ...
        'timezone_auto' => 'Auto — fuso do navegador (:tz)',
        'timezone_description' => 'Calendário, agendamento e datas das publicações são exibidos neste fuso para todo o workspace.',
        'datetime_format' => 'Formato de data e hora',
        'datetime_format_auto' => 'Auto — padrão do idioma',
        'datetime_format_description' => 'Aplicado ao calendário e a todas as listas de publicações.',
        'save' => 'Salvar',
