...
return [
    ...
    */
    ...
    'social_email_unverified' => 'Не удалось подтвердить вашу почту через :provider. Подтвердите её там или войдите по почте и паролю.',
    ...
    'register' => [
        ...
        'log_in' => 'Войти',
        'disposable_email' => 'Используйте постоянный адрес электронной почты. Временные адреса не принимаются.',
        'quota_reached' => 'Сейчас не удалось создать аккаунт. Попробуйте позже.',
    ],
    ...
    'verify_email' => [
        ...
        'log_out' => 'Выйти',
        'sent_to' => 'Письмо отправлено на',
        'instructions' => 'Проверьте входящие (и папку со спамом на всякий случай). Чтобы продолжить, подтвердите почту.',
        'wrong_email' => 'Неверная почта? Исправьте',
        'new_email_label' => 'Новая почта',
        'update_email' => 'Сохранить и отправить снова',
        'cancel' => 'Отмена',
    ],
