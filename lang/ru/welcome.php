...
return [
    ...
    'connect_title' => 'Подключите соцсеть',
    'connect_description' => 'Выберите хотя бы одну сеть, где TryPost сможет публиковать ваш контент. Можно продолжить и сделать это позже.',
];
