...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => ':platform için özel metin',
            'active' => 'açık',
            'hint' => 'Boşsa gönderinin ortak metni kullanılır.',
            'placeholder' => 'Yalnızca bu platform için metin…',
            'over_limit' => 'Bu platformun sınırını aşıyor (:limit karakter).',
        ],
        'location' => [
            'label' => 'Konum',
            'id_placeholder' => 'Yer ID',
            'name_placeholder' => 'Ad (görünüm)',
            'hint' => 'Facebook yer ID’si; yer arama üçüncü taraflara kapalı — ID’yi bir kez bulun ve yeniden kullanın.',
        ],
        'youtube' => [
            ...
            'title' => 'Başlık',
            'title_placeholder' => 'Video başlığı (gönderinin ilk satırı yerine)',
            'title_hint' => 'En fazla 100 karakter; metinden türetildiğinde " #Shorts" otomatik eklenir.',
            'tags' => 'Etiketler',
            'tags_placeholder' => 'brisbane, pixel art, harita',
            'tags_hint' => 'Virgülle ayrılır; arama ve önerilere yardımcı olur.',
