...
return [
    ...
    'connect_title' => 'Підключіть соцмережу',
    'connect_description' => 'Оберіть принаймні одну мережу, де TryPost зможе публікувати ваш контент. Можете продовжити і зробити це пізніше.',
];
