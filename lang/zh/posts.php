...
return [
    ...
    'form' => [
        ...
        'custom_caption' => [
            'label' => '为 :platform 定制文本',
            'active' => '启用',
            'hint' => '留空则使用帖子共用文本。',
            'placeholder' => '仅用于此平台的文本…',
            'over_limit' => '超过该平台上限(:limit 个字符)。',
        ],
        'location' => [
            'label' => '位置',
            'id_placeholder' => '地点 ID',
            'name_placeholder' => '名称(展示用)',
            'hint' => 'Facebook 地点 ID;地点搜索已对第三方关闭,请查一次 ID 后重复使用。',
        ],
        'youtube' => [
            'settings' => 'YouTube 设置',
            'posting_to' => '发布到',
            ...
            'title' => '标题',
            'title_placeholder' => '视频标题(代替帖子的第一行)',
            'title_hint' => '最多 100 个字符;由正文生成时会自动附加" #Shorts"。',
            'tags' => '标签',
            'tags_placeholder' => 'brisbane, pixel art, map',
            'tags_hint' => '用逗号分隔;有助于搜索和推荐。',
            'category' => '类别 ID',
            'language' => '语言',
            'location' => '拍摄地点',
