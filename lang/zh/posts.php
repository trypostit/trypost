...
return [
    ...
    'composer' => [
        ...
        'assistant_rephrase' => '改写',
        'assistant_shorten' => '缩短',
        'assistant_expand' => '扩写',
        'assistant_prompt_question' => '您想写什么内容？',
        'assistant_prompt_placeholder' => '请描述帖子内容、目标受众和期望效果。',
        'assistant_tip' => '提示：请写明要点、目标受众和期望效果。',
        'assistant_generate' => '生成',
        'assistant_suggestion' => '建议文案',
        'assistant_apply' => '应用到帖子',
        'assistant_back' => '返回',
        'assistant_error' => '无法生成建议，请重试。',
        'save_draft' => '保存草稿',
        'create_another' => '再创建一条',
        'templates' => '模板',
        'expand' => '展开对话框',
        'post_previews' => '帖子预览',
        'preview_empty' => '帖子预览将显示在这里',
        'select_all' => '全选',
        'deselect_all' => '取消全选',
        'last_used' => '最近使用',
        'collapse' => '退出全屏',
        'now' => '现在',
        'now_description' => '立即发布帖子。',
        'set_date_time' => '设置日期和时间',
        'set_date_time_description' => '选择具体的发布时间。',
        'publish_now' => '立即发布',
        'customize_networks' => '针对每个平台自定义',
        'use_shared' => '使用共享内容',
        'media_upload_failed' => '无法上传媒体文件，请重试。',
