...
return [
    ...
    'workspace' => [
        ...
        'timezone' => '时区',
        'timezone_auto' => '自动 — 浏览器时区 (:tz)',
        'timezone_description' => '日历、排期和帖子日期将以此时区向工作区所有成员显示。',
        'datetime_format' => '日期和时间格式',
        'datetime_format_auto' => '自动 — 随界面语言',
        'datetime_format_description' => '应用于日历和所有帖子列表。',
        'save' => '保存',
