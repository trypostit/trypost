...
return [
    ...
    'workspace' => [
        ...
        'delete_members_warning' => '{1}另有 :count 位成员将失去对此账户的访问权限，并被转移到各自的个人账户。|[2,*]另有 :count 位成员将失去对此账户的访问权限，并被转移到各自的个人账户。',
        'delete_action' => '删除工作区',
        'delete_cancel' => '取消',
    ...
    'flash' => [
        ...
        'delete_failed_billing' => '无法在账单提供商处取消订阅。你的工作区已被移除，但账户尚未删除。请重试或联系支持。',
        'logo_updated' => '徽标上传成功！',
        'logo_deleted' => '徽标移除成功！',
