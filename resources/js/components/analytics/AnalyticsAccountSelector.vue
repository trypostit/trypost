            ...
            >
                <template v-if="selected">
                    <div class="relative shrink-0">
                        <Avatar
                            class="size-7 rounded-full border border-border shadow-2xs"
                        >
                            <AvatarImage
                            ...
                            />
                            <AvatarFallback
                                class="rounded-full bg-amber-100 text-xs font-bold text-foreground"
                            >
                                {{ getInitials(selected.display_label) }}
                            </AvatarFallback>
                        </Avatar>
                        <span
                            class="absolute -right-1 -bottom-1 inline-flex size-4 items-center justify-center overflow-hidden rounded-full border border-border bg-card shadow-2xs"
                        >
                            <img
                ...
                <CommandList>
                    ...
                    <CommandGroup>
                        ...
                        >
                            <div class="relative shrink-0">
                                <Avatar
                                    class="size-9 rounded-full border border-border shadow-2xs"
                                >
                                    <AvatarImage
                                    ...
                                    />
                                    <AvatarFallback
                                        class="rounded-full bg-amber-100 font-bold text-foreground"
                                    >
