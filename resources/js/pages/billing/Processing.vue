...
<template>
    ...
    >
        ...
        <!-- Mockup window -->
        <div
            class="relative w-full max-w-md overflow-hidden rounded-xl border border-border bg-card shadow-lg"
        >
            <!-- Title bar -->
            <div
            ...
            >
                <div
                    class="flex size-16 items-center justify-center rounded-2xl border border-border bg-muted shadow-xs"
                >
