            ...
            <section class="space-y-12">
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        <div
                            ...
                            :key="session.id"
                            :class="[
                                'flex items-center gap-4 rounded-xl border border-border p-4 shadow-2xs',
                                session.is_current
                                    ? 'bg-emerald-50'
                                    : 'bg-card',
                            ]"
                        ...
                        >
                            <div
                                :class="[
                                    'inline-flex size-10 flex-shrink-0 items-center justify-center rounded-xl border border-border shadow-xs',
                                    session.is_current
                                        ? 'bg-emerald-200'
                                        : 'bg-amber-100',
                                ]"
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        >
                            <div
                                class="inline-flex size-10 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl border border-border bg-card shadow-xs"
                            >
                                <img
