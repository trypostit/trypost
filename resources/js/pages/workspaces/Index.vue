    ...
    >
        <div class="space-y-3">
            <div
                ...
                :key="workspace.id"
                class="flex cursor-pointer items-center gap-3 rounded-xl border border-border bg-card p-4 shadow-2xs transition-all hover:-translate-y-0.5 hover:shadow-md"
                :class="
                    workspace.id === currentWorkspaceId ? 'bg-amber-100' : ''
                "
