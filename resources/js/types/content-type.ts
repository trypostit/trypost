export const ContentType = {
    ...
    GoogleBusinessProfileStandard: 'google_business_profile_standard',
    GoogleBusinessProfileEvent: 'google_business_profile_event',
    GoogleBusinessProfileOffer: 'google_business_profile_offer',
    GoogleBusinessProfileAlert: 'google_business_profile_alert',
    XPost: 'x_post',
