...
use App\Console\Commands\ReconcileGoogleBusinessProfilePosts;
...
Schedule::command(ReconcileGoogleBusinessProfilePosts::class)->everyFiveMinutes()->withoutOverlapping()->onOneServer();
